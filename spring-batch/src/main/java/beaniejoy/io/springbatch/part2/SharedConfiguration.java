package beaniejoy.io.springbatch.part2;
    ...
    public Step sharedStep() {
        return stepBuilderFactory.get("sharedStep")
            .tasklet((contribution, chunkContext) -> {
                // 각 execution에서 ExecutionContext 꺼낼 수 있다. (job, step)
                StepExecution stepExecution = contribution.getStepExecution();
                // jobExecutionContext, stepExecutionContext -> ExecutionContext
